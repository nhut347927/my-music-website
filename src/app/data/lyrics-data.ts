...
import nghekelanam90 from "../asset/lyric-img/nghekelanam90.jpg";
import vuonhoaconca from "../asset/lyric-img/vuonhoaconca.jpg";
import olew from "../asset/lyric-img/olew.jpg";
import phamnguyenngoc from "../asset/lyric-img/phamnguyenngoc.jpg";
import quendatten from "../asset/lyric-img/quendatten.jpg";

import vanmaihuong from "../asset/lyric-img/vanmaihuong.jpg";
import motngangnoidau from "../asset/lyric-img/motngangnoidau.jpg";
import fishy from "../asset/lyric-img/fishy.jpg";
import vetthuong from "../asset/lyric-img/vetthuong.jpg";
import emgioi from "../asset/lyric-img/emgioi.jpg";
import jack from "../asset/lyric-img/jack.jpg";
import domdom from "../asset/lyric-img/domdom.jpg";
import anhoianholai from "../asset/lyric-img/anhoianholai.jpg";
import chipu from "../asset/lyric-img/chupu.jpg";
import noinaycoanh from "../asset/lyric-img/noinaycoanh.jpg";
...
export const lyricsData: LyricPost[] = [
...

  {
    ...
    lyrics: [
      {
        type: "Intro",
        content:
          "Nghe kể là năm chín mươi em dạo cùng anh ta\nĐi khắp phố xá đêm nay không về nhà\nNghe kể là năm chín mươi chuyện tình của hai ta\nHệt như cuốn phim em xem khi chiều tà",
      },
      {
        type: "Verse 1",
        content:
          "Dòng người bước vội từng bước qua từng con phố\nTrông rất quen nhưng xa lạ liệu ta từng bước qua\nBật khúc hát vừa đâu đây\nVẫn còn vang trong chiếc radio ánh đèn kia dần buông lơi\n\nCó bao nhiêu này sáu mươi năm câu chuyện tình yêu trong đời\nEm ngân nga dạo khắp xung quanh tìm một bài ca em quên lời\nTu tu tu đu đu đu đù\nKhông thời gian cứ lắng động từng giây\nPa pa pa đa đi đa đà\nĐôi tình nhân trong giấc mộng chiều nay",
      },
      {
        type: "Chorus",
        content:
          "Nghe kể là năm chín mươi em dạo cùng anh ta\nĐi khắp phố xá đêm nay không về nhà\nNghe kể là năm chín mươi chuyện tình của hai ta\nHệt như cuốn phim em xem khi chiều tà (chiều tà)",
      },
      {
        type: "Verse 2",
        content:
          "Sau hoàng hôn màn đêm buông xuống\nĐứng đợi anh lướt qua trên con Vespa màu xanh\nTrốn mẹ cha như là phim quay góc phố\nAlo anh đào hoa này papa không cho đến gần\n\nMama nói em sai vì ngày ấy em đã trao anh\nTrao từng giây em trao luôn chiếc hôn nồng nàn\nDòng người kia qua mau khi thấy ta vội vàng\nNăm chín mấy anh ơi\nĐôi tình nhân cứ thế buông lơi\n\nTrong khoảnh khắc em mong giữa thế gian xoay vòng\nDòng người kia qua mau ta khiến ta yếu lòng\nTa ta ta đa đi đa ta\nKhông thời gian như lắng đọng từng giây\nTa ta ta đa đi đa ta\nĐôi tình nhân trong giấc mộng chiều nay",
      },
      {
        type: "Bridge",
        content: "Nếu chúng ta quay lại năm chín mươi thì sẽ thế nào anh nhỉ",
      },
      {
        type: "Chorus (Final)",
        content:
          "Nghe kể là năm chín mươi em dạo cùng anh ta\nĐi khắp phố xá đêm nay không về nhà\nNghe kể là năm chín mươi chuyện tình của hai ta\nHệt như cuốn phim em xem khi chiều tà\n\nRồi một thời cũng đã đi qua ấy\nTìm lại gì chuyện của hai ta\nVề cuộc hẹn hò mới hôm qua\nThước phim ngày hè\n\nNăm chín mấy em ơi\nĐôi tình nhân cứ thế buông lơi\nTrong khoảnh khắc em bỏ giữa thế gian xoay vòng\nDòng người kia qua mau khi ấy ta nao lòng",
      },
      {
        type: "Outro (spoken + hát)",
        content:
          "Em cảm thấy hình như là mình quen nhau lâu lắm rồi\nAnh cũng có cảm giác giống vậy\nĐể em nói thiệt cho anh nghe nha\nEm rất là thích anh\nAnh biết\nĐể anh nói thiệt cho em nghe nha\nAnh không có cận thị đâu",
      },
    ],
    year: "2024",
    duration: "03:48",
    singerPhoto: anngo.src,
    composer: "Ân Nợ, HURRYKNG, marzuz",
    producer: "Yinba Entertainment",
    otherSongs: [
      "Em Đồng Ý (I Do)",
      "Đắm (ft. marzuz)",
      "Anh Nghĩ Em Vẫn Thích Anh",
      "Cua",
    ],
    userCommentAvatar: anonymous.src,
    userNameComment: "Anonymous",
    userRoleComment: "Admin",
    comment:
      "Nghe Kể Là Năm 90 - hiện tượng Vpop cuối 2024, đầu 2025. Với giai điệu retro mơ màng pha chút city-pop, lời hát hoài niệm về một mối tình tưởng như từ thập niên 90 cùng đoạn thoại viral cuối bài, ca khúc của Ân Nợ đã phủ sóng khắp TikTok và Spotify Việt Nam, khiến cả Gen Z lẫn 8x-9x đều ‘yếu lòng’.",
  },
  {
    id: 23,
    ...
    lyrics: [
      ...
      },
      {
        type: "Chorus",
        content:
          "Ngàn lời em nói thương anh là em thương thật mà\nTừng ngày nỗi nhớ em đem trao cho anh thật mà\nDù muộn phiền có theo em từ chỗ làm về nhà\nThì chỉ cần nhớ môi anh là u phiền trôi qua\n\nTháng năm sống không có em anh vất vả nhiều rồi\nTừ giờ hãy để em ôm anh trong vòng tay em thôi\nMột chút yêu thương nhẹ nhàng\nBình yên thôi chẳng vội vàng\nThật lòng em muốn bên anh thương anh qua từng năm tháng thanh xuân",
      },
      {
        type: "Post-Chorus",
        content: "Ah yeah BCTM for life",
      },
      {
        type: "Verse 2 (Rap - Ngắn)",
        content:
          "Từ một cậu bé tin vào tình yêu cả trăm phần trăm\nVà cứ như thế cậu trưởng thành chai sạn qua nhiều năm\nVẫn không có gì thay đổi không bao giờ lăn và tăn\nVẫn cứ yêu điên khùng cho dù xung quanh cản ngăn\n\nVì bản thân không hối hận với những thứ đã làm (ta sẽ làm)\nCho đi cho đi hết y như con dã tràng\nCần làm nhiều hơn thế với những thứ mà ta đã bàn\nKhông quan tâm thời gian đâu vì\nAnh vẫn luôn tin em\nTin nhiều hơn cả bản thân mình nữa khui chai sâm banh\n\nTặng cho em đứa con và kèm thêm bình sữa\nYêu em nhiều hơn tình đầu không bao giờ cho mình sầu\nĐôi chân còn đi con tim còn đập thì anh vẫn luôn nguyện cầu\nHai ta vẫn yêu đến khi trái đất này không còn quay nữa\n\nKhông có thiên đàng hay địa ngục vì ta đang ở ngay giữa\nĐặt một tình yêu lên môi cho đi những giấc mơ tuyệt vời\nRồi một ngày nắng sẽ đến bên em chúc em tháng năm rạng ngời",
      },
      {
        type: "Bridge",
        content:
          "Có khi ta giận nhau nên chẳng nói lời hay\nNhưng đâu cần thiết nghĩ suy\nVì đâu thể lớn hơn tình yêu ta",
      },
      {
        type: "Chorus (Final)",
        content:
    ...
    year: "2023",
    duration: "03:54",
    singerPhoto: olew.src, // ảnh O.lew thực tế trong public/images/
    composer: "O.lew, Ngắn",
    producer: "Sony Music Entertainment",
    otherSongs: [
      "Rồi Ta Sẽ Ngắm Pháo Hoa Cùng Nhau",
      "Sống Cho Hết Đời Thanh Xuân 2",
      "Sống Cho Hết Đời Thanh Xuân 3",
      "AiScReam",
    ], // các bài nổi bật của O.lew và liên quan BCTM
    userCommentAvatar: anonymous.src,
    userNameComment: "Anonymous",
    userRoleComment: "Admin",
    comment:
      "‘Vườn Hoa Con Cá’ – bản tình ca ngọt ngào viral từ 2023 của O.lew feat. Ngắn (thành viên BCTM). Với hình ảnh đời thường ‘chăm cá, tưới hoa’ tượng trưng cho tình yêu bình dị, healing, kết hợp rap chân thành về niềm tin tình yêu bất diệt, bài hát đã 'càn quét' TikTok và Spotify, chạm đến trái tim Gen Z khao khát mối quan hệ lâu dài, không drama.",
  },
  {
    id: 24,
    ...
    year: "2022",
    duration: "04:15", // thời lượng bài hát dựa trên MV chính thức
    singerPhoto: phamnguyenngoc.src, // ảnh ca sĩ thực tế trong public/images/
    composer: "Phạm Nguyên Ngọc",
    producer: "Phạm Nguyên Ngọc",
    otherSongs: [
      "Mặt Mộc (ft. BMZ)",
      "Hạt Nắng Vỡ Đôi (ft. BMZ)",
      "Yêu Đơn Phương",
      "Em Đã Yêu Anh",
    ], // các bài nổi bật khác của Phạm Nguyên Ngọc
    userCommentAvatar: anonymous.src,
    userNameComment: "Anonymous",
    userRoleComment: "Admin",
    comment:
      "'Quên Đặt Tên' – ca khúc Ballad sâu lắng ra mắt năm 2022 của Phạm Nguyên Ngọc, khắc họa nỗi đau tình yêu tuổi đôi mươi với những hình ảnh thơ mộng như cơn bão, nắng mưa và thư tình gửi vào nắng. Với giai điệu da diết và giọng hát đầy cảm xúc, bài hát nhanh chóng chạm đến trái tim người nghe, trở thành hit Vpop hoài niệm về thanh xuân và những lời hứa dang dở.",
  },
  {
    id: 25,
    ...
    year: "2022",
    duration: "05:21", // thời lượng bài hát từ Apple Music/Spotify
    singerPhoto: vanmaihuong.src, // ảnh ca sĩ thực tế trong public/images/
    composer: "Hứa Kim Tuyền",
    producer: "Hứa Kim Tuyền",
    otherSongs: [
      "Mưa Tháng Sáu (ft. GREY D, Trung Quân)",
      "Hương (ft. Negav)",
      "Nghe Nói Anh Sắp Kết Hôn (ft. Bùi Anh Tuấn)",
      "Ước Mơ Của Mẹ",
    ], // các bài nổi bật khác của Văn Mai Hương
    userCommentAvatar: anonymous.src,
    userNameComment: "Anonymous",
    userRoleComment: "Admin",
    comment:
      "'Một Ngàn Nỗi Đau' – bản ballad da diết năm 2022 của Văn Mai Hương, sáng tác bởi Hứa Kim Tuyền dựa trên câu chuyện thật về 'người đến sau'. Với giọng hát đầy cảm xúc khắc họa nỗi đau tình yêu dang dở, lời ca như lời tâm sự lúc 11:11, MV gây sốt với diễn xuất chân thực và thông điệp về sự đa dạng trong Pride Month, nhanh chóng đạt triệu views và chạm đến trái tim khán giả Vpop.",
  },
  {
    id: 26,
    ...
    year: "2023",
    duration: "03:45", // thời lượng bài hát dựa trên Spotify
    singerPhoto: fishy.src, // ảnh ca sĩ thực tế trong public/images/
    composer: "Fishy",
    producer: "Fishy",
    otherSongs: [
      "Fallen In Love (ft. Trí Dũng)",
      "Forget Me Now (ft. Trí Dũng)",
      "Phố Không Mùa",
      "Yêu Em Lâu Hơn",
    ], // các bài nổi bật khác của Fishy
    userCommentAvatar: anonymous.src,
    userNameComment: "Anonymous",
    userRoleComment: "Admin",
    comment:
      "'Vết Thương' – bản ballad indie sâu lắng năm 2023 của Fishy, khắc họa nỗi đau tình yêu tan vỡ qua những hình ảnh hoài niệm về ký ức, cơn say và thành phố đêm. Với giai điệu mơ màng, lời ca chân thực như lời tự sự về việc níu giữ quá khứ và những vết thương vô hình, bài hát nhanh chóng viral trên Spotify và TikTok, chạm đến trái tim những ai từng trải qua chia ly đầy day dứt.",
  },
  {
    id: 27,
    ...
    year: "2019",
    duration: "04:14", // thời lượng bài hát từ Spotify/YouTube
    singerPhoto: jack.src, // ảnh Jack thực tế trong public/images/
    composer: "Jack",
    producer: "K-ICM",
    otherSongs: [
      "Hồng Nhan",
      ...
      "Bạc Phận (ft. K-ICM)",
      "Hoa Vô Sắc",
    ], // các bài nổi bật khác của Jack
    userCommentAvatar: anonymous.src,
    userNameComment: "Anonymous",
    userRoleComment: "Admin",
    comment:
      "'Em Gì Ời' – hit Vpop 2019 của Jack feat. K-ICM, với giai điệu vui tươi, bắt tai pha rap và ballad, lời ca khích lệ vượt qua nỗi buồn, ôm lấy cuộc sống tự do. Sau 24h ra mắt đạt 12 triệu views, hiện nay vượt mốc 279 triệu, trở thành biểu tượng thanh xuân cho thế hệ trẻ, dù từng vướng tranh cãi đạo nhạc.",
  },
  {
    id: 28,
    ...
    userRoleComment: "Admin",
    comment:
      "Đóm Đóm – kiệt tác ballad 2021 của Jack (J97), dành tặng fandom Đóm và người con gái anh từng yêu. Với giai điệu da diết, ca từ đậm chất thơ miền Trung và hình ảnh “đóm đóm” tượng trưng cho tình yêu cháy mãi trong tim, bài hát đã chạm mốc hơn 168 triệu views, trở thành một trong những bản tình ca buồn được cover nhiều nhất Vpop thập kỷ.",
  },
  {
    id: 29,
    ...
    lyrics: [
      ...
      {
        type: "Verse 2 (Repeat Pre-Chorus + Chorus variation)",
        content:
    ...
    userRoleComment: "Admin",
    comment:
      "“Anh Ơi Anh Ở Lại” – bản ballad comeback cực mạnh của Chi Pu cuối 2024, do Đạt G sáng tác. Với câu hát “Anh ơi anh ở lại” và hình ảnh cầu vồng – bông hoa tàn úa, bài hát nhanh chóng phủ sóng TikTok, chiếm mọi BXH và trở thành “quốc ca chia tay” mới của Gen Z. MV drama + giọng hát đầy cảm xúc đã giúp Chi Pu chứng minh sức hút không hề giảm sau nhiều năm.",
  },
  {
    id: 30,
    ...
    year: "2017",
    duration: "04:20", // thời lượng bài hát từ Spotify
    singerPhoto: sontung.src, // ảnh ca sĩ thực tế trong public/images/
    ...
    otherSongs: [
      ...
      "Muộn Rồi Mà Sao Còn",
    ], // các bài nổi bật khác của Sơn Tùng M-TP
    userCommentAvatar: anonymous.src,
    userNameComment: "Anonymous",
    userRoleComment: "Admin",
    comment:
      "'Nơi Này Có Anh' – bản tình ca kinh điển 2017 của Sơn Tùng M-TP, tự sáng tác và sản xuất. Với giai điệu pop/R&B ngọt ngào, lời ca lãng mạn về tình yêu bất diệt qua bốn mùa, bài hát đã đạt hơn 250 triệu views trên YouTube, trở thành biểu tượng Vpop, thường được dùng trong MV phim và cover hàng triệu lần bởi fan Sky.",
  },
  {
    id: 31,
    ...
    lyrics: [
      {
        type: "Verse 1",
        content:
          "Một chiều em đến con tim hoá ngập tràn\nCùng bao si mê chẳng muộn màng\nCó tiếng nói bên tai sẽ chẳng thể biến tan\nGiờ lòng chỉ biết tơ vương đến một người\nỞ bên em không phải gượng cười\nThấy trước mắt đôi ta sẽ vui với hiện tại",
      },
      {
        type: "Pre-Chorus",
        content:
          "Biển tình mênh mông có ánh dương\nSẽ chiếu sáng nơi thánh đường\nKhẽ dẫn lối đôi chân ta đi chung một hướng\nĐường đời đôi lúc sẽ có những nhấp nhô\nHệt đại dương mênh mông có sóng xô\nĐừng lo lắng vì luôn có anh trên tàu",
      },
      {
        type: "Chorus",
        content:
          "Anh ôm đôi vai này đêm ngày không thoát ra được đâu (đâu)\nÔm theo bao giấc mơ ở trong từng tháng năm kia nhiệm màu (màu)\nEm ơi xin đừng xa chàng đông vẫn luôn lạnh giá\nĐừng để lòng tan nát đến bao ngày tháng ta không chung lối\n\nDu dương câu ca gọi tên nàng cho trái tim rộn vang\nAnh vẫn cứ ngẩn ngơ chìm đắm theo những suy tư ghé ngang\nAnh luôn tin về nơi ta đã có hồi ức vẹn nguyên luôn ở đó\nNguyện được cùng trái tim mời gọi hết những yêu thương trên đời",
      },
      {
        type: "Hook",
        content:
          "Thật lòng giờ anh chỉ muốn cho con tim giá băng thấy em cười\nĐể được sưởi ấm nơi này hãy hé môi em thật tươi\nDù một ngàn năm đi nữa anh xin trao hết tất cả những nhớ thương\nCùng đi đến muôn phương kiếp sau vẫn chung đường",
      },
      {
        type: "Verse 2",
        content:
          "Đến đây mà xem ngôi sao trên trời cũng chẳng thể bằng em (chẳng thể bằng em)\nĐừng cố để tập quên thanh âm sáng ngời anh lưu giữ trên bậc thềm\nNhịp tim anh bỗng phút chốc đập liên hồi khi có ánh nắng ở bên đời\nThảnh thơi chìm vào trong những cơn mơ (em ơi em ơi)\n\nLạc vào khu rừng hoa khu rừng ngập mùi hương người ta\nDành tặng em bài ca kỷ niệm tháng năm ta đã qua\nỞ bên anh được không (khi vắng người)\nLòng này cứ trống rỗng (như lên mười)\nĐầu vẫn mãi lưu luyến đến nụ cười tươi",
      },
      {
        type: "Chorus + Hook (Final)",
        content:
          "Thật lòng giờ anh chỉ muốn cho con tim giá băng thấy em cười\nĐể được sưởi ấm nơi này hãy hé môi em thật tươi (thật tươi)\nDù một ngàn năm đi nữa anh xin trao hết tất cả những nhớ thương\nCùng đi đến muôn phương kiếp sau vẫn chung đường (ta chung một đường về)\n\nVì thật lòng giờ anh chỉ muốn cho con tim giá băng thấy em cười\nĐể được sưởi ấm nơi này hãy hé môi em thật tươi\nDù một ngàn năm đi nữa anh xin trao hết tất cả những nhớ thương\nCùng đi đến muôn phương kiếp sau vẫn chung đường",
      },
      {
        type: "Outro",
        content:
    ...
    year: "2024",
    duration: "04:28",
    singerPhoto: duongg.src,
    composer: "Duongg, T.R.I",
    producer: "Duongg Entertainment",
    otherSongs: [

...
export const blogData: BlogsPost[] = [
...

  {
    ...
    title:
      "Cách Vượt Qua Khó Khăn Thử Thách Trong Cuộc Sống: 10 Bước Thực Tế Giúp Bạn Mạnh Mẽ Hơn Bao Giờ Hết",
    categories: [categoriesData[28], categoriesData[32], categoriesData[31]], // Phát triển bản thân & Sống tích cực & Tâm lý học
    ...
    paragraphs: [
...

      {
        type: "title",
        content:
          "7. Chăm sóc cơ thể – Bạn không thể mạnh mẽ khi cơ thể kiệt quệ",
      },
      {
        type: "text",
        content:
...

      {
        type: "title",
        content:
          "9. Nhắc nhở bản thân: “Đây không phải lần đầu nhân loại gặp khó khăn”",
      },
      {
        type: "text",
        content:
  ...
  },
  {
    ...
    title:
      "Cách Ngừng Suy Nghĩ Quá Nhiều (Overthinking): 9 Cách Đơn Giản Mà Hiệu Quả Tức Thì",
    categories: [categoriesData[28], categoriesData[32], categoriesData[31]], // Phát triển bản thân & Sống tích cực & Sức khỏe tâm thần
    ...
    paragraphs: [
      ...
      },
      {
        type: "text",
        content:
          "Lấy giấy bút, viết hết mọi thứ đang ám ảnh bạn. Sau đó xé nhỏ hoặc đốt (an toàn nhé). Hành động vật lý này gửi tín hiệu mạnh mẽ đến não: “Đã xử lý xong vấn đề”. Tôi làm cách này từ 2022, giờ chỉ còn overthinking khoảng 2–3 lần/tháng thay vì mỗi ngày.",
      },
      ...
      },
      {
        type: "text",
        content:
          "Overthinking luôn đi kèm căng cơ (vai, cổ, hàm). Nằm hoặc ngồi thẳng, hít sâu, từ từ quét sự chú ý từ đỉnh đầu xuống bàn chân, thả lỏng từng vùng. Khi cơ thể thư giãn, não tự động ngừng sản xuất suy nghĩ tiêu cực.",
      },
      ...
      },
      {
        type: "text",
        content:
          "Chọn 15 phút cố định mỗi ngày (ví dụ 19h–19h15) làm “ giờ lo lắng chính thức. Trong ngày, cứ thấy lo là tự nhủ: “Để tối 19h tao lo tiếp”. 80% suy nghĩ sẽ tự tan biến vì đến giờ bạn… lười lo.",
      },
      ...
      },
      {
        type: "text",
        content:
          "Xóa hoặc mute các nhóm drama, các tài khoản tiêu cực, ngừng xem lại tin nhắn cũ, ngừng kiểm tra xem người yêu cũ có vào xem story không… Mỗi lần bạn làm những việc đó, não nhận được một liều dopamine độc hại khiến vòng overthinking càng mạnh hơn.",
      },
  ...
  },
  {
    ...
    title:
      "Cách Bảo Vệ Tâm Trí Khi Xung Quanh Toàn Năng Lượng Xấu: 9 Thói Quen Giúp Bạn Vẫn Mềm Lòng Nhưng Không Còn Tự Làm Mình Đau Nữa",
    categories: [categoriesData[28], categoriesData[32], categoriesData[31]], // Phát triển bản thân & Sống tích cực & Sức khỏe tâm thần
    ...
    paragraphs: [
      ...
      },
      {
        type: "text",
        content:
          "Mỗi tối dành đúng 3 phút để viết hết lời độc hại nghe trong ngày ra giấy → gấp lại → bỏ vào hộp “Rác ngày”. Cuối tuần đốt hoặc xé bỏ.\nHành động vật lý này giúp não hiểu: “Đã xử lý xong, không cần replay nữa”.",
      },

      {
        type: "title",
        content:
          "5. Câu thần chú 8 chữ: “Miệng họ, nghiệp họ, liên quan gì tao?”",
      },
      {
        type: "text",
        content:
          "Dán câu này vào điện thoại, vào màn hình máy tính, vào gương nhà vệ sinh. Mỗi lần bị công kích, đọc thầm 3 lần. Sau 2–3 tuần nó sẽ tự động bật lên như một phản xạ có điều kiện.",
      },
      ...
      },
      {
        type: "text",
        content:
          "Tạo một playlist 10 bài yêu thích nhất, một góc bàn nhỏ với nến thơm và quyển sổ tay, một nhóm chat chỉ có 2–3 người tích cực.\nMỗi lần bị tấn công → về ngay vùng an toàn trong vòng 5 phút. Đây là nơi bạn nạp lại năng lượng, không cho độc hại theo về.",
      },
    ...
    comment:
      "Bảo vệ tâm trí khỏi năng lượng xấu là một kỹ năng quan trọng trong cuộc sống hiện đại, nơi mà chúng ta thường xuyên tiếp xúc với những lời nói và hành động tiêu cực từ người khác. Bằng cách áp dụng những thói quen đơn giản nhưng hiệu quả như đã đề cập trong bài viết, bạn có thể duy trì sự bình yên trong tâm hồn mà không cần phải trở nên vô cảm hay lạnh lùng. Hãy nhớ rằng, việc bảo vệ bản thân không chỉ giúp bạn tránh khỏi đau khổ mà còn tạo điều kiện cho sự phát triển cá nhân và hạnh phúc lâu dài. Bạn hoàn toàn có thể mềm lòng nhưng vẫn giữ được sự vững vàng trong tâm trí của mình.",
  },

  {
    ...
    title:
      "Hạnh Phúc Ở Tuổi Trưởng Thành Không Còn Là Cảm Giác, Mà Là Một Quyết Định",
    categories: [categoriesData[28], categoriesData[32], categoriesData[31]], // Phát triển bản thân & Sống chậm & Nội tâm
    ...
    paragraphs: [
      ...
      },
      {
        type: "text",
        content:
          "Bạn từng nghĩ phải có người yêu đúng chuẩn, phải có nhà, phải có con, phải có danh xưng gì đó mới được phép hạnh phúc. Đến một ngày bạn thấy tất cả những thứ ấy có thể đến rồi đi, còn mình vẫn cần sống tiếp vào ngày mai.\n\nKhi ấy bạn hiểu: thứ duy nhất không ai lấy đi được chính là khả năng tự tạo ra ý nghĩa của chính mình.",
      },

      {
        type: "title",
        content:
          "2. Chấp nhận rằng sẽ có những ngày rất tệ, và đó là bình thường",
      },
      {
        type: "text",
        content:
          "Tuổi trẻ tin rằng hạnh phúc là không có ngày buồn. Tuổi trưởng thành biết rằng hạnh phúc là có thể buồn mà không đánh mất chính mình.\n\nBuồn vì mất người, buồn vì thất bại, buồn không lý do – đều được phép tồn tại. Chỉ cần không để nỗi buồn ấy định nghĩa toàn bộ con người bạn.",
      },
      ...
      },
      {
        type: "text",
        content:
          "Một thói quen buổi sáng không ai làm phiền. Một giá sách chỉ bạn hiểu thứ tự. Một playlist không cần giải thích với ai. Một tách cà phê pha đúng tỷ lệ.\n\nỞ tuổi trưởng thành, hạnh phúc thường bắt đầu từ những lãnh thổ tí hon mà bạn làm chủ tuyệt đối.",
      },
      ...
      },
      {
        type: "text",
        content:
          "Ngày không drama, không deadline cháy, không ai làm mình tổn thương – đó không phải ngày vô vị, đó là ngày xa xỉ nhất của người trưởng thành.\n\nBạn học được cách tận hưởng sự đều đều như cách người ta từng thèm khát bão tố.",
      },

      {
        type: "title",
        content:
          "6. Biết ơn những mối quan hệ còn lại sau khi đã lọc hết độc hại",
      },
      {
        type: "text",
        content:
          "Số bạn bè trong điện thoại giảm đi 80%, nhưng mỗi lần gặp là thấy ấm. Không cần nói nhiều, không cần chứng minh, không cần giữ thể diện.\n\nỞ tuổi này, một người hiểu mình im lặng cũng đủ làm cả ngày sáng lên.",
      },
      ...
      },
      {
        type: "text",
        content:
          "Không còn ép mình chạy bộ để đẹp cho ai xem, mà chạy vì biết 20 năm nữa đầu gối vẫn cần khỏe. Không còn nhịn ăn để mặc vừa quần cũ, mà ăn để hôm nay có đủ năng lượng yêu thương bản thân một chút nữa.\n\nTự yêu mình, hóa ra là dự án dài hơi nhất và đáng đầu tư nhất.",
      },
      ...
      },
      {
        type: "text",
        content:
          "Từng yêu sai người, từng tin sai người, từng cố gắng làm hài lòng tất cả. Giờ nhìn lại không thấy xấu hổ, chỉ thấy thương phiên bản cũ của mình quá.\n\nTha thứ là cách bạn ôm lấy đứa trẻ bên trong và nói: “Thôi, về nhà với chị, từ giờ chị lo.”",
      },
  ...
  },
  {
    ...
    paragraphs: [
      // MỞ ĐẦU
      {
        type: "text",
        content:
          "Hầu hết mọi người hỏi “Có nên kinh doanh không?” đều đang chờ một câu trả lời có/không.\n\nSự thật là không có câu trả lời chung. Có người sinh ra để làm chủ, có người sinh ra để làm thuê xuất sắc, và cả hai đều có thể sống rất ổn, thậm chí rất giàu.\n\nCâu hỏi đúng phải là: “Mình có sẵn sàng trả cái giá của tự do kinh doanh không?”\n\nBài này không khuyên bạn nhảy hay không nhảy. Nó đưa ra 9 câu hỏi trung thực nhất. Trả lời xong, chính bạn sẽ biết mình thuộc nhóm nào – không cần ai phán xét.",
      },

      {
        type: "title",
        content:
          "1. Bạn có chấp nhận 3–5 năm đầu có thể không có lương cố định không?",
      },
      {
        type: "text",
        content:
          "90% startup Việt Nam không có lãi trong 3 năm đầu. Nhiều người tháng nào cũng phải bơm tiền cá nhân vào công ty. Nếu ý nghĩ “không có lương 3 tháng” đã khiến bạn hoảng loạn, thì chưa sẵn sàng.",
      },

      {
        type: "title",
        content:
          "2. Bạn có chịu được cảm giác “không ai hiểu mình” trong ít nhất 3 năm?",
      },
      {
        type: "text",
        content:
          "Bạn bè đi nhậu, đi du lịch, còn bạn ngồi tính bảng chi phí. Gia đình bảo “thôi đi làm công ty lớn cho chắc ăn”. Khách hàng chửi. Nhân viên nghỉ ngang. Không có ai vỗ vai khen bạn giỏi – chỉ có bạn với chính bạn lúc 3h sáng.",
      },
      ...
      },
      {
        type: "text",
        content:
          "Sẽ có ngày bạn phải chọn giữa tình nghĩa và sự sống còn của công ty. Người từng cùng bạn ăn mì gói khởi nghiệp có thể là người đầu tiên phải mời ra khỏi công ty. Nếu không làm được, công ty chết, cả đám cùng chết.",
      },

      {
        type: "title",
        content:
          "4. Bạn có đủ sức khỏe tâm lý để chịu đựng sự bất định liên tục?",
      },
      {
        type: "text",
        content:
          "Doanh thu tháng này 2 tỷ, tháng sau có thể về 200 triệu. Khách hàng lớn hủy hợp đồng vào ngày 30. Đối tác quỵt tiền. Thuế dí. Ngân hàng đòi nợ. Đó không phải “có thể xảy ra”, đó là sẽ xảy ra – nhiều lần.",
      },

      {
        type: "title",
        content:
          "5. Bạn có khả năng tự học mỗi ngày như một thói quen sống còn?",
      },
      {
        type: "text",
        content:
          "Làm chủ = tự học vĩnh viễn. Hôm nay bạn phải hiểu TikTok Ads, ngày mai phải đọc báo cáo tài chính, ngày kia phải học cách đàm phán với nhà đầu tư. Không có sếp nhắc, không có deadline của ai ngoài chính bạn.",
      },

      {
        type: "title",
        content:
          "6. Bạn có sẵn sàng đánh đổi thời gian cho gia đình và sức khỏe trong giai đoạn đầu?",
      },
      {
        type: "text",
        content:
          "Rất nhiều founder thành công nhưng ly hôn, con không thân, sức khỏe xuống cấp. Không phải ai cũng vậy, nhưng xác suất cao hơn người làm công rất nhiều. Bạn có chấp nhận được không?",
      },
      ...
      },
      {
        type: "text",
        content:
          "Thống kê toàn cầu: 80% startup chết trong 5 năm đầu. Ở Việt Nam còn cao hơn. Người thành công thường là người thất bại lần thứ 3–4. Bạn có đủ tiền, đủ tinh thần và đủ người thân ủng hộ để thất bại vài lần không?",
      },

      {
        type: "title",
        content:
          "8. Bạn kinh doanh vì muốn giàu nhanh hay vì thấy vấn đề cần giải quyết?",
      },
      {
        type: "text",
        content:
          "Nếu chỉ vì “muốn giàu”, bạn sẽ bỏ cuộc khi thấy làm công ăn lương dễ hơn nhiều. Nếu bạn thấy ngứa mắt vì một vấn đề mà không ai giải quyết được, và bạn sẵn sàng dành 10 năm để giải nó – thì bạn có DNA của người làm chủ.",
      },
      ...
      },
      {
        type: "text",
        content:
          "Đây là câu hỏi cuối cùng và mạnh nhất. Hãy tưởng tượng mình 70 tuổi, ngồi nhìn lại. Lúc ấy bạn sẽ tiếc vì đã kinh doanh và thất bại, hay tiếc vì chưa từng dám thử?\nCâu trả lời của bạn chính là đáp án cuối cùng.",
      },
